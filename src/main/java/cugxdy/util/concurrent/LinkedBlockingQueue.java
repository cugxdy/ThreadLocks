...
//     }
     ...
     */
    // 创建LinkedBlockingQueue对象,容量默认为int型的最大值
    ...
    public LinkedBlockingQueue(Collection<? extends E> c) {
        ...
        try {
            ...
            for (E e : c) {
                ...
                if (n == capacity)// 当容量已满时,抛出IllegalStateException异常
